diff --git a/brain_codex_review_20260503_172723/source/README.md b/brain_codex_review_20260503_172723/source/README.md  
new file mode 100644  
index 0000000000000000000000000000000000000000..b32910a79e86315da73b4373f9b4134000f918db  
--- /dev/null  
+++ b/brain_codex_review_20260503_172723/source/README.md  
@@ -0,0 +1,31 @@  
...
+## Files  
+  
+- `brain_v11_1_aipro.py` — visible Python source code for review.  
...
+## Source Integrity  
+  
+Expected SHA256 for `brain_v11_1_aipro.py`:  
+  
+```text  
